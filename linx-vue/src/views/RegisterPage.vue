                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12" dir="ltr">
                    ...
                    <div class="space-y-6">
                        ...
                        <form @submit.prevent="register" class="space-y-4">
                            <input v-model="form.name" type="text" :placeholder="$t('auth.register.name')"   :class="[
    'form-input',
    $i18n.locale === 'fa' ? 'text-right' : 'text-left'
  ]" />
                            <input v-model="form.email" type="email" :placeholder="$t('auth.register.email')"   :class="[
    'form-input',
    $i18n.locale === 'fa' ? 'text-right' : 'text-left'
  ]" />
                            <input v-model="form.password" type="password" :placeholder="$t('auth.register.password')"   :class="[
    'form-input',
    $i18n.locale === 'fa' ? 'text-right' : 'text-left'
  ]" />
                            <input v-model="form.password_confirmation" type="password" :placeholder="$t('auth.register.confirm_password')"   :class="[
    'form-input',
    $i18n.locale === 'fa' ? 'text-right' : 'text-left'
  ]" />
